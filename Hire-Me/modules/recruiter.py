...
def posted():
    ...
    search = Button(rt, text="Sort", font=('normal', 12, 'bold'),
                    bg="#00459A", fg="#ffffff", command=lambda: sort_all(table))
    search.grid(row=0, column=3, padx=10, pady=10, ipadx=15)
    dlt = Button(rt, text="Delete", font=('normal', 12, 'bold'),
                 bg="#00459A", fg="#ffffff", command=lambda: deletjob(table))
...
def app():
    ...
    search = Button(rt, text="Sort", font=('normal', 12, 'bold'),
                    bg="#00459A", fg="#ffffff", command=lambda: sort_applicants(table))
